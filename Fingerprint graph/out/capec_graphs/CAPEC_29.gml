graph [
  ...
  prerequisites "The adversary is able to modify resource."
  prerequisites "A race condition exists while accessing a resource."
  ...
  related_weaknesses "691"
  related_weaknesses "663"
  ...
  node [
    id 2
    label "confirm_ability_to_modify_the_targeted_resource"
  ]
  node [
    id 3
    label "decide_to_leverage_the_race_condition_by_running_the_race"
  ]
  node [
    id 4
