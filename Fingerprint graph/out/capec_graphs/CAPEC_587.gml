graph [
  ...
  prerequisites "The user's browser must have vulnerabilities in its implementation of the same-origin policy. It allows certain data in a loaded page to originate from different servers/domains."
  skills_required "[]"
  resources_required "[]"
  ...
  mitigations "Avoid clicking on untrusted links."
  mitigations "Employ techniques such as frame busting, which is a method by which developers aim to prevent their site being loaded within a frame."
  ...
  node [
    id 0
    label "have_vulnerabilities_in_its_implementation_of_the_same_origin_policy"
  ]
]
