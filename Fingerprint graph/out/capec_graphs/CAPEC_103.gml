graph [
  ...
  prerequisites "The victim's browser security policies allow at least one of the following JavaScript, Flash, iFrames, ActiveX, or CSS."
  prerequisites "The victim uses a modern browser that supports UI elements like clickable buttons (i.e. not using an old text only browser)"
  prerequisites "The victim has an active session with the target system."
  prerequisites "The target system's interaction window is open in the victim's browser and supports the ability for initiating sensitive actions on behalf of the user in the target system"
  skills_required "_networkx_list_start"
  skills_required [
    level "High"
    description "Crafting the proper malicious site and luring the victim to this site are not trivial tasks."
  ]
  ...
  execution_flow [
    ...
    techniques "The adversary leveraged iframe overlay capabilities to craft a malicious clickjacking page"
    techniques "The adversary leveraged Flash file overlay capabilities to craft a malicious clickjacking page"
    techniques "The adversary leveraged Silverlight overlay capabilities to craft a malicious clickjacking page"
    techniques "The adversary leveraged cross-frame scripting to craft a malicious clickjacking page"
  ]
  execution_flow [
    step "2"
    phase "Exploit"
    ...
    techniques "Lure the victim to the malicious site by sending the victim an e-mail with a URL to the site."
    techniques "Lure the victim to the malicious site by manipulating URLs on a site trusted by the victim."
    techniques "Lure the victim to the malicious site through a cross-site scripting attack."
  ]
  execution_flow [
    step "3"
    phase "Exploit"
  ...
  node [
    id 0
    label "craft_a_clickjacking_page"
  ]
  node [
    id 1
    label "leverage_flash_file_overlay_capabilities"
  ]
  node [
    id 2
  ...
  node [
    id 6
    label "provide_an_electronic_payment_service"
  ]
  node [
    id 7
    label "receive_an_e"
  ...
  node [
    id 8
    label "read_the_news_article"
  ]
  node [
    id 9
    label "activate_a_hidden_action_control_located_in_a_transparent_layer_above_the_skip_this_ad_button"
  ]
  node [
    id 10
    label "block_the_news_article"
  ]
  node [
    id 11
    label "allow_at_least_one_of_the_following_javascript_flash_iframes_activex_or_css"
  ]
  node [
    id 12
